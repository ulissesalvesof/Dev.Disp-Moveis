...
class AuthRepository {
    ...
    suspend fun getUserName(): String? {
        return try {
            ...
            Log.e("AuthRepository", "Erro ao resgatar nome do usuário: ${e.message}")
            null
        }
    }

    // Obter o cliente do Google Sign-In
    fun getGoogleSignInClient(context: android.content.Context): GoogleSignInClient {
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(context.getString(com.example.planner.R.string.default_web_client_id)) // Use o client ID do seu projeto
            .requestEmail()
            .build()
